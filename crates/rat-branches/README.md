...
This crate provides reusable algorithms and UI components for working with tree-like data structures, extracted from clankers-tui's conversation branch system.
